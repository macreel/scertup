...
$(function() {
  ...
  //             return '<button class="sub-nav-right-toggler"> <i class="fa fa-chevron-right"></i> </button>';
  //         });
  ...
  //                 return '<button class="sub-nav-right-right-toggler"> <i class="fa fa-chevron-right"></i> </button>';
  //             });
